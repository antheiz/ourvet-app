...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <a href="/komunitas/detail_pertanyaan" class="btn btn-warning text-white"><b> <i class="fas fa-arrow-circle-left"></i> Kembali</b></a>
        </div>
        <div class="">
    ...
    <div class="col">
        <div class="col-6 mt-5 pb-5 pt-3 mb-3 bg-white" style="border-radius: 10px">
            <p>
                <b>
    ...
    <div class="jumbotron bg-white" style="width: 80%; margin-left:120px">
        <h5 class="text-center" style="color: #47525E; margin-top:-50px">Beri Pertanyaan</h5>
        <hr style="border: 1px solid; color:rgb(209, 209, 209)">
        <i class="fas fa-user-circle mt-4 d-" style="font-size: 30px"></i>
        <p>Budi</p>
        <textarea name="" id="" cols="78" rows="5" class="ml-5"></textarea>
        <br>
