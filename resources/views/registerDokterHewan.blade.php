        ...
        <div class="jumbotron mt-3" style="background-color: #FFBA5C; width:80%;">
            ...
            <div>
                <form>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Nama Tempat Praktek ">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" id="only-number" placeholder="Tahun Bekerja">
                    </div>
                    {{-- field Tahun Bekerja, gimana caranya supaya cuma bisa input/masukin angka doang? --}}
                    <div class="form-group">
